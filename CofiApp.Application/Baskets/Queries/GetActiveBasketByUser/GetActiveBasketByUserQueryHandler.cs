...
{
    public class GetActiveBasketByUserQueryHandler :
        IQueryHandler<GetActiveBasketByUserQuery, Maybe<BasketResponse>>
    {
        private readonly IDbContext _dbContext;
        private readonly IUserIdentifierProvider _userIdentifierProvider;

        public GetActiveBasketByUserQueryHandler(IDbContext dbContext, IUserIdentifierProvider userIdentifierProvider)
        {
            _dbContext = dbContext;
            _userIdentifierProvider = userIdentifierProvider;
        }

        public async Task<Maybe<BasketResponse>> Handle(GetActiveBasketByUserQuery request, CancellationToken cancellationToken)
        {
